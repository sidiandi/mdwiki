...
GitHubContentProvider.prototype.createPage = function (commitMessage, pageName, markdownText) {
  var messageBody = {
    ...
    content: new Buffer(markdownText).toString('base64'),
    branch: 'master'
  };
...
GitHubContentProvider.prototype.updatePage = function (commitMessage, pageName, markdownText, sha) {
  var messageBody = {
    message: commitMessage,
    content: new Buffer(markdownText).toString('base64'),
    sha: sha,
...
GitHubContentProvider.prototype.deletePage = function (pageName, sha) {
  var deferred = q.defer(),
      url = urlBuilder.buildPageUrl(this.userName, this.repositoryName, pageName).concat(urlBuilder.withAccessToken(this.oauth));
