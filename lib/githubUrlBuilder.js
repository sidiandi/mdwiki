...
var BLOB_BASE_URI = 'https://api.github.com/repos/%s/%s/git/blobs/%s';
...
var buildBlobUrl = function (user, repository, sha) {
  return util.format(BLOB_BASE_URI, user, repository, sha);
};
...
module.exports.buildBlobUrl = buildBlobUrl;
