...
var folderToSearch = path.join(__dirname, '../content');

var setFolderToSearch = function (folder) {
  folderToSearch = folder;
};

var searchForText = function (textToSearch) {
...
module.exports.setFolderToSearch = setFolderToSearch;
